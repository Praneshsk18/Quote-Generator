...
- **Tailwind CSS** styling with a custom Spirited Away color palette
...
Output is written to `dist/quote-generator`.

## Tech Stack

- **Frontend:** Angular 19, Tailwind CSS 3
- **Quotes API:** [Quotable](https://api.quotable.io/random)
